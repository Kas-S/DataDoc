...
!(function (t, n) {
      ...
      if ((a = t._squarify) && a.ratio === n)
        for (var a, u, c, f, s, l = -1, h = a.length, d = t.value; ++l < h; ) {
          ...
          u.dice
            ...
            : Zd(u, e, r, d ? (e += ((i - e) * u.value) / d) : i, o),
            (d -= u.value);
        }
  ...
  function rp(t) {
    ...
    let r,
      i = 2;
    for (r = 2; r < n; ++r) {
      for (; i > 1 && np(t[e[i - 2]], t[e[i - 1]], t[r]) <= 0; ) --i;
      e[i++] = r;
    }
    return e.slice(0, i);
  }
  ...
  function Dp(t, n, e) {
    var r = t[0],
      ...
      a = n[1];
    return (
      i < r ? ((r = zp(i, r)), (o = e(a, o))) : ((r = zp(r, i)), (o = e(o, a))),
      function (t) {
        return o(r(t));
      }
    );
  ...
  function Vp(n) {
    ...
    function u() {
      return (
        ...
        r()[0] < 0 ? ((i = Gp(i)), (o = Gp(o)), n(jp, Hp)) : n(Yp, Lp),
        e
      );
    }
    return (
  ...
  function tg(t) {
    var n = t(Pp, Pp),
      e = 1;
    function r() {
      return 1 === e ? t(Pp, Pp) : 0.5 === e ? t(Qp, Jp) : t(Kp(e), Kp(1 / e));
    }
    return (
    ...
    return (
      ...
      e &&
        ((i.count = function (n, r) {
          return (
            ig.setTime(+n), og.setTime(+r), t(ig), t(og), Math.floor(e(ig, og))
          );
        }),
        (i.every = function (t) {
          return (
  ...
  var vg = ag(
    ...
    Mg = ag(
      function (t) {
        t.setTime(
          t - t.getMilliseconds() - t.getSeconds() * sg - t.getMinutes() * lg
        );
      },
      function (t, n) {
        t.setTime(+t + n * hg);
    ...
    Sg = ag(
      ...
      (t, n) =>
        (n - t - (n.getTimezoneOffset() - t.getTimezoneOffset()) * lg) / dg,
      (t) => t.getDate() - 1
    ),
    Eg = Sg,
    kg = Sg.range;
  function Ng(t) {
    return ag(
      ...
      function (t, n) {
        return (
          (n - t - (n.getTimezoneOffset() - t.getTimezoneOffset()) * lg) / pg
        );
      }
    );
  }
  ...
  const [Ey, ky] = Sy(Ay, xy, ay, ry, ty, Kg),
    [Ny, Cy] = Sy($g, Xg, Cg, Eg, Ag, xg);
  function Py(t) {
    if (0 <= t.y && t.y < 100) {
    ...
    function M(t, n) {
      return function (e) {
        ...
        if (
          ...
          "w" in o || (o.w = 1),
            "Z" in o
              ? ((i = (r = zy(Dy(o.y, 0, 1))).getUTCDay()),
                (r = i > 4 || 0 === i ? uy.ceil(r) : uy(r)),
                (r = ry.offset(r, 7 * (o.V - 1))),
                (o.y = r.getUTCFullYear()),
                (o.m = r.getUTCMonth()),
                (o.d = r.getUTCDate() + ((o.w + 6) % 7)))
              : ((i = (r = Py(Dy(o.y, 0, 1))).getDay()),
        ...
        return "Z" in o
          ? ((o.H += (o.Z / 100) | 0), (o.M += o.Z % 100), zy(o))
          : Py(o);
      };
    }
    function A(t, n, e, r) {
      for (var i, o, a = 0, u = n.length, c = e.length; a < u; ) {
        ...
        if (37 === (i = n.charCodeAt(a++))) {
          if (
            ((i = n.charAt(a++)),
            !(o = x[i in Fy ? n.charAt(a++) : i]) || (r = o(t, e, r)) < 0)
          )
            return -1;
  ...
  function kv(t, n) {
    var e = t.getDay();
    return By(
      (t = e >= 4 || 0 === e ? qg(t) : qg.ceil(t)).getFullYear() % 1e4,
      n,
      4
    );
  }
  ...
  function Lv(t, n) {
    return (
      (t = Yv(t)), By(sy.count(Ay(t), t) + (4 === Ay(t).getUTCDay()), n, 2)
    );
  }
  function jv(t) {
    return t.getUTCDay();
  ...
  var n_ = Date.prototype.toISOString
      ? function (t) {
  ...
  var p_ = d_("1f77b4ff7f0e2ca02cd627289467bd8c564be377c27f7f7fbcbd2217becf"),
    ...
    Mb = new Array(3)
      ...
      .map(d_),
    Ab = A_(Mb);
  var Tb = Wr(ur(300, 0.5, 0), ur(-240, 0.5, 1)),
    Sb = Wr(ur(-100, 0.75, 0.35), ur(80, 1.5, 0.8)),
    Eb = Wr(ur(260, 0.75, 0.35), ur(80, 1.5, 0.8)),
    kb = ur();
  var Nb = Ae(),
    Cb = Math.PI / 3,
    Pb = (2 * Math.PI) / 3;
  ...
  function sm(t, n) {
    ...
    return (
      (t = "function" == typeof t ? t : void 0 === t ? cm : Ob(t)),
      (n = "function" == typeof n ? n : void 0 === n ? fm : Ob(n)),
      (a.x = function (n) {
        return arguments.length
          ? ((t = "function" == typeof n ? n : Ob(+n)), a)
          : t;
      }),
      (a.y = function (t) {
        return arguments.length
          ? ((n = "function" == typeof t ? t : Ob(+t)), a)
          : n;
      }),
      (a.defined = function (t) {
        return arguments.length
          ? ((e = "function" == typeof t ? t : Ob(!!t)), a)
          : e;
      }),
      (a.curve = function (t) {
  ...
  function lm(t, n, e) {
    ...
    return (
      (t = "function" == typeof t ? t : void 0 === t ? cm : Ob(+t)),
      (n = "function" == typeof n ? n : Ob(void 0 === n ? 0 : +n)),
      (e = "function" == typeof e ? e : void 0 === e ? fm : Ob(+e)),
      (c.x = function (n) {
        return arguments.length
          ? ((t = "function" == typeof n ? n : Ob(+n)), (r = null), c)
          : t;
      }),
      (c.x0 = function (n) {
        return arguments.length
          ? ((t = "function" == typeof n ? n : Ob(+n)), c)
          : t;
      }),
      (c.x1 = function (t) {
        return arguments.length
          ? ((r = null == t ? null : "function" == typeof t ? t : Ob(+t)), c)
          : r;
      }),
      (c.y = function (t) {
        return arguments.length
          ? ((n = "function" == typeof t ? t : Ob(+t)), (e = null), c)
          : n;
      }),
      (c.y0 = function (t) {
        return arguments.length
          ? ((n = "function" == typeof t ? t : Ob(+t)), c)
          : n;
      }),
      (c.y1 = function (t) {
        return arguments.length
          ? ((e = null == t ? null : "function" == typeof t ? t : Ob(+t)), c)
          : e;
      }),
      (c.lineX0 = c.lineY0 =
        function () {
  ...
  function Mm(t) {
    ...
    return (
      ...
      (a.x = function (t) {
        return arguments.length
          ? ((r = "function" == typeof t ? t : Ob(+t)), a)
          : r;
      }),
      (a.y = function (t) {
        return arguments.length
          ? ((i = "function" == typeof t ? t : Ob(+t)), a)
          : i;
      }),
      (a.context = function (t) {
    ...
    jm = {
      draw: function (t, n) {
        ...
        t.moveTo(r, i),
          t.lineTo(o, a),
          t.lineTo(u, c),
          t.lineTo(Im * r - Bm * i, Bm * r + Im * i),
          t.lineTo(Im * o - Bm * a, Bm * o + Im * a),
          t.lineTo(Im * u - Bm * c, Bm * u + Im * c),
          t.lineTo(Im * r + Bm * i, Im * i - Bm * r),
          t.lineTo(Im * o + Bm * a, Im * a - Bm * o),
          t.lineTo(Im * u + Bm * c, Im * c - Bm * u),
          t.closePath();
      },
    },
  ...
  function gx(t, n, e) {
    var r = t._x1 - t._x0,
      ...
      u = (o * i + a * r) / (r + i);
    return (
      (px(o) + px(a)) * Math.min(Math.abs(o), Math.abs(a), 0.5 * Math.abs(u)) ||
      0
    );
  }
  function yx(t, n) {
      ...
      lineEnd: function () {
        ...
        if (e)
          if (
            ...
            for (var r = wx(t), i = wx(n), o = 0, a = 1; a < e; ++o, ++a)
              this._context.bezierCurveTo(
                r[0][o],
                i[0][o],
                r[1][o],
  ...
  var zx = (t) => () => t;
  function Dx(t, { sourceEvent: n, target: e, transform: r, dispatch: i }) {
    Object.defineProperties(this, {
      type: { value: t, enumerable: !0, configurable: !0 },
      sourceEvent: { value: n, enumerable: !0, configurable: !0 },
      target: { value: e, enumerable: !0, configurable: !0 },
  ...
  qx.prototype = {
    ...
    translate: function (t, n) {
      return (0 === t) & (0 === n)
        ? this
        : new qx(this.k, this.x + this.k * t, this.y + this.k * n);
    },
    apply: function (t) {
  ...
  var Rx = new qx(1, 0, 0);
  function Fx(t) {
    for (; !t.__zoom; ) if (!(t = t.parentNode)) return Rx;
    return t.__zoom;
  }
  function Ox(t) {
    t.stopImmediatePropagation();
  ...
  (Fx.prototype = qx.prototype),
    ...
    (t.arc = function () {
      ...
      function c() {
        ...
        if ((u || (u = c = ya()), l < s && ((f = l), (l = s), (s = f)), l > Xb))
          if (p > $b - Xb)
            u.moveTo(l * Bb(h), l * jb(h)),
              u.arc(0, 0, l, h, d, !g),
              s > Xb &&
                (u.moveTo(s * Bb(d), s * jb(d)), u.arc(0, 0, s, d, h, g));
          else {
            var y,
              v,
              _ = h,
      ...
      return (
        ...
        (c.endAngle = function (t) {
          return arguments.length
            ? ((o = "function" == typeof t ? t : Ob(+t)), c)
            : o;
        }),
        (c.padAngle = function (t) {
          return arguments.length
            ? ((a = "function" == typeof t ? t : Ob(+t)), c)
            : a;
        }),
        (c.context = function (t) {
    ...
    (t.curveBundle = Qm),
    (t.curveCardinal = nx),
    (t.curveCardinalClosed = rx),
    (t.curveCardinalOpen = ox),
    (t.curveCatmullRom = cx),
    (t.curveCatmullRomClosed = sx),
    (t.curveCatmullRomOpen = hx),
    (t.curveLinear = um),
    ...
    (t.interpolateBlues = pb),
    (t.interpolateBrBG = S_),
    (t.interpolateBuGn = H_),
    (t.interpolateBuPu = G_),
    ...
    (t.interpolateCool = Eb),
    (t.interpolateCubehelix = $r),
    (t.interpolateCubehelixDefault = Tb),
    ...
    (t.interpolateGnBu = $_),
    (t.interpolateGreens = yb),
    (t.interpolateGreys = _b),
    (t.interpolateHcl = Xr),
    ...
    (t.interpolateMagma = qb),
    (t.interpolateNumber = Tr),
    (t.interpolateNumberArray = xr),
    (t.interpolateObject = Sr),
    (t.interpolateOrRd = Z_),
    (t.interpolateOranges = Ab),
    (t.interpolatePRGn = k_),
    (t.interpolatePiYG = C_),
    (t.interpolatePlasma = Fb),
    (t.interpolatePuBu = tb),
    (t.interpolatePuBuGn = Q_),
    (t.interpolatePuOr = z_),
    (t.interpolatePuRd = eb),
    (t.interpolatePurples = mb),
    ...
    (t.interpolateRdBu = q_),
    (t.interpolateRdGy = F_),
    (t.interpolateRdPu = ib),
    (t.interpolateRdYlBu = U_),
    (t.interpolateRdYlGn = B_),
    (t.interpolateReds = wb),
    (t.interpolateRgb = vr),
    ...
    (t.interpolateSinebow = function (t) {
      ...
      return (
        (t = (0.5 - t) * Math.PI),
        (Nb.r = 255 * (n = Math.sin(t)) * n),
        (Nb.g = 255 * (n = Math.sin(t + Cb)) * n),
        (Nb.b = 255 * (n = Math.sin(t + Pb)) * n),
        Nb + ""
      );
    }),
    (t.interpolateSpectral = L_),
    ...
    (t.interpolateViridis = Db),
    (t.interpolateWarm = Sb),
    (t.interpolateYlGn = cb),
    (t.interpolateYlGnBu = ab),
    ...
    (t.radialLine = _m),
    (t.randomBates = sp),
    (t.randomBernoulli = dp),
    (t.randomBeta = yp),
    (t.randomBinomial = vp),
    (t.randomCauchy = bp),
    (t.randomExponential = lp),
    (t.randomGamma = gp),
    (t.randomGeometric = pp),
    (t.randomInt = ap),
    (t.randomIrwinHall = fp),
    (t.randomLcg = function (t = Math.random()) {
      let n = 0 | (0 <= t && t < 1 ? t / wp : Math.abs(t));
      return () => ((n = (1664525 * n + 1013904223) | 0), wp * (n >>> 0));
    }),
    (t.randomLogNormal = cp),
    (t.randomLogistic = mp),
    (t.randomNormal = up),
    (t.randomPareto = hp),
    (t.randomPoisson = xp),
    ...
    (t.scaleIdentity = function t(n) {
      ...
      return (
        ...
        (n = arguments.length ? Array.from(n, Np) : [0, 1]),
        Ip(r)
      );
    }),
    (t.scaleImplicit = Tp),
    ...
    (t.scaleLog = function t() {
      const n = Vp(Fp()).domain([1, 10]);
      return (
        (n.copy = () => Rp(n, t()).base(n.base())), Mp.apply(n, arguments), n
      );
    }),
    (t.scaleOrdinal = Sp),
    ...
    (t.scaleRadial = function t() {
      ...
      return (
        ...
        (o.range = function (t) {
          return arguments.length
            ? (e.range((r = Array.from(t, Np)).map(eg)), o)
            : r.slice();
        }),
    ...
    (t.scaleTime = function () {
      return Mp.apply(
        u_(Ny, Cy, $g, Xg, Cg, Eg, Ag, xg, _g, t.timeFormat).domain([
          new Date(2e3, 0, 1),
          new Date(2e3, 0, 2),
        ]),
        arguments
    ...
    (t.scaleUtc = function () {
      return Mp.apply(
        u_(Ey, ky, Ay, xy, ay, ry, ty, Kg, _g, t.utcFormat).domain([
          Date.UTC(2e3, 0, 1),
          Date.UTC(2e3, 0, 2),
        ]),
        arguments
    ...
    (t.stack = function () {
      ...
      function i(i) {
        ...
        for (o = 0, a = om(n(u)); o < c; ++o) u[a[o]].index = o;
        return e(u, a), u;
      }
      return (
        (i.keys = function (n) {
          return arguments.length
            ? ((t = "function" == typeof n ? n : Ob(Array.from(n))), i)
            : t;
        }),
        (i.value = function (t) {
          return arguments.length
            ? ((r = "function" == typeof t ? t : Ob(+t)), i)
            : r;
        }),
        (i.order = function (t) {
          return arguments.length
    ...
    (t.symbol = function (t, n) {
      ...
      return (
        (t = "function" == typeof t ? t : Ob(t || Em)),
        (n = "function" == typeof n ? n : Ob(void 0 === n ? 64 : +n)),
        (r.type = function (n) {
          return arguments.length
            ? ((t = "function" == typeof n ? n : Ob(n)), r)
            : t;
        }),
        (r.size = function (t) {
          return arguments.length
            ? ((n = "function" == typeof t ? t : Ob(+t)), r)
            : n;
        }),
    ...
    (t.timeDay = Eg),
    (t.timeDays = kg),
    (t.timeFormatDefaultLocale = Jv),
    (t.timeFormatLocale = qy),
    (t.timeFriday = Rg),
    (t.timeFridays = Lg),
    (t.timeHour = Ag),
    (t.timeHours = Tg),
    (t.timeInterval = ag),
    (t.timeMillisecond = cg),
    (t.timeMilliseconds = fg),
    (t.timeMinute = xg),
    (t.timeMinutes = wg),
    (t.timeMonday = Pg),
    (t.timeMondays = Ug),
            ...
            for (
              ...
              (c = Xd(c)),
                ...
                (i = u.z + l - o.z - f + t(u._, o._)) > 0 &&
                  (Vd($d(u, n, r), n, i), (f += i), (s += i)),
                (l += u.m),
                (f += o.m),
                (h += c.m),
                (s += a.m);
            u && !Gd(a) && ((a.t = u), (a.m += l - s)),
              o && !Xd(c) && ((c.t = o), (c.m += f - h), (r = n));
          }
          return r;
        })(n, i, n.parent.A || r[0]);
      }
    ...
    (t.zoom = function () {
      ...
      return (
        ...
        (y.wheelDelta = function (t) {
          return arguments.length
            ? ((a = "function" == typeof t ? t : zx(+t)), y)
            : a;
        }),
        (y.filter = function (t) {
          return arguments.length
            ? ((r = "function" == typeof t ? t : zx(!!t)), y)
            : r;
        }),
        (y.touchable = function (t) {
          return arguments.length
            ? ((u = "function" == typeof t ? t : zx(!!t)), y)
            : u;
        }),
        (y.extent = function (t) {
          return arguments.length
